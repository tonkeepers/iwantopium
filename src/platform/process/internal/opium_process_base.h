...
void        opium_process_base_bind(opium_process_base_t *base,
      opium_process_base_handler_t *handler);

opium_s32_t opium_process_base_init(opium_process_base_t *base);
opium_s32_t opium_process_base_validate(opium_process_base_t *base);
opium_s32_t opium_process_base_apply(opium_process_base_t *base);
opium_s32_t opium_process_base_reset(opium_process_base_t *base);
opium_s32_t opium_process_base_collect(opium_process_base_t *base);
opium_s32_t opium_process_base_diff(opium_process_base_t *base);

void       *opium_process_base_config(opium_process_base_t *base);
void       *opium_process_base_metric(opium_process_base_t *base);
