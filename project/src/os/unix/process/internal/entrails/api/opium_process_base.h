...
typedef struct {
   ...
   opium_process_base_func_t    func;

   opium_log_t                 *log;
} opium_process_base_t;

opium_process_base_t *opium_process_base_create(opium_slab_t *slab, char *name, size_t cs, size_t ms,
      opium_log_t *log);
void                  opium_process_base_exit(opium_process_base_t *base);

void                  opium_process_base_bind(opium_process_base_t *base, opium_process_base_func_t *func);
